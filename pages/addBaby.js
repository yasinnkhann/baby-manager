...
export default function AddBaby() {
  ...
  return (
    <main className="font-['Rubik'] h-screen mx-auto w-1/2 flex flex-col justify-center">
      <h1 className='font-medium self-center text-4xl'>Add A Baby</h1>
      <ChildCareIcon className='self-center' sx={{ fontSize: 140 }} />
      <FormControl sx={{ m: 1, minWidth: 80 }} className='flex flex-col'>
        <TextField className='py-4 pb-10' id='name' label='Name' variant='standard'></TextField>
